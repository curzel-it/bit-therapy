...
class CollisionsTests(unittest.TestCase):
    ...
    def test_multiple_collisions_can_be_detected(self):
        main = Entity(SPECIES_AGENT, "main", Rect(0, 0, 1, 1), self.test_env)
    ...
    def test_distant_entities_do_not_collide(self):
        entity1 = Entity(SPECIES_AGENT, "entity1", Rect(0, 0, 1, 1), self.test_env)
        entity2 = Entity(SPECIES_AGENT, "entity2", Rect(2, 2, 1, 1), self.test_env)
    ...
    def test_entities_sharing_one_corner_collide(self):
        entity1 = Entity(SPECIES_AGENT, "entity1", Rect(0, 0, 1, 1), self.test_env)
        entity2 = Entity(SPECIES_AGENT, "entity2", Rect(1, 1, 1, 1), self.test_env)
        collision = entity1.collision(entity2)
    ...
    def test_entities_sharing_one_side_collide(self):
        entity1 = Entity(SPECIES_AGENT, "entity1", Rect(0, 0, 1, 1), self.test_env)
        entity2 = Entity(SPECIES_AGENT, "entity2", Rect(1, 0, 1, 1), self.test_env)
        collision = entity1.collision(entity2)
    ...
    def test_overlapping_entities_collide(self):
        entity1 = Entity(SPECIES_AGENT, "entity1", Rect(0, 0, 2, 2), self.test_env)
        entity2 = Entity(SPECIES_AGENT, "entity2", Rect(1, 1, 2, 2), self.test_env)
        collision = entity1.collision(entity2)
    ...
    def test_sides_detected_when_same_height_object_perfectly_collides_on_right(self):
        entity1 = Entity(SPECIES_AGENT, "entity1", Rect(0, 0, 1, 1), self.test_env)
        entity2 = Entity(SPECIES_AGENT, "entity2", Rect(0.9, 0, 1, 1), self.test_env)
        collision = entity1.collision(entity2)
    ...
    def test_sides_detected_when_smaller_collides_on_right(self):
        entity1 = Entity(SPECIES_AGENT, "entity1", Rect(0, 0, 1, 1), self.test_env)
        entity2 = Entity(
            SPECIES_AGENT, "entity2", Rect(0.9, 0.25, 1, 0.5), self.test_env
        )
        collision = entity1.collision(entity2)
        sides = collision.sides()
        self.assertEqual(
    ...
    def test_sides_detected_when_larger_collides_on_right(self):
        entity1 = Entity(SPECIES_AGENT, "entity1", Rect(0, 0, 1, 1), self.test_env)
        entity2 = Entity(SPECIES_AGENT, "entity1", Rect(0.9, -1, 1, 3), self.test_env)
        collision = entity1.collision(entity2)
        sides = collision.sides()
        self.assertEqual(
            sides, [CollisionSide.TOP, CollisionSide.RIGHT, CollisionSide.BOTTOM]
    ...
    def test_sides_detected_when_object_collides_on_top_right(self):
        entity1 = Entity(SPECIES_AGENT, "entity1", Rect(0, 0, 1, 1), self.test_env)
        entity2 = Entity(SPECIES_AGENT, "entity2", Rect(0.9, 0.9, 1, 1), self.test_env)
        collision = entity1.collision(entity2)
        sides = collision.sides()
