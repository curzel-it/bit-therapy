...
class Hotspot(Enum):
    ...
    def build_bottom_bound(cls, world) -> Entity:
        entity = Entity(
            ...
            Rect(0, world.bounds.height, world.bounds.width, BOUNDS_THICKNESS),
            world,
        )
    ...
    def build_left_bound(cls, world) -> Entity:
        entity = Entity(
            ...
            Rect(0, 0, BOUNDS_THICKNESS, world.bounds.height),
            world,
        )
        entity.is_static = True
        return entity
    ...
    def build_right_bound(cls, world) -> Entity:
        entity = Entity(
            ...
            Rect(world.bounds.width, 0, BOUNDS_THICKNESS, world.bounds.height),
            world,
        )
        entity.is_static = True
        return entity
