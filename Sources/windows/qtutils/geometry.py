...
Rect.as_qrect = lambda value: QRect(int(value.min_x), int(value.min_y), int(value.width), int(value.height))
Rect.as_rect = lambda value: Rect(float(value.x()), float(value.y()), float(value.width()), float(value.height()))
