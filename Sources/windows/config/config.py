...
class Config:
    def __init__(self, **kwargs):
        ...
        self.gravity_enabled = BehaviorSubject(kwargs.get("gravity_enabled") or True)
        self.pet_size = BehaviorSubject(kwargs.get("pet_size") or 75)
        self.selected_species = BehaviorSubject(
            kwargs.get("selected_species") or ["cat_blue"]
        )
        self.speed_multiplier = BehaviorSubject(kwargs.get("speed_multiplier") or 1)
